"""
This is my recommended version of step 4.
The other version makes the code that they wrote for the pizza box do nothing (it never displays)
Here, it is made into a loading screen for 2 seconds when the game is launched.
I just didn't like the idea of having them do something just to not do anything with it.
-Thomas Pelowitz
"""
